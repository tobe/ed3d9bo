...
INT APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR  lpCmdLine, int nCmdShow) {
    ...
    try {
        ...
        //g_pOverlay = new ed3d9bo::Overlay(hInstance, "Notepad", "Untitled - Notepad", "Testing", nullptr); < also as nullptr
        ...
        */
        g_pDraw = new Draw(g_pOverlay->GetFont(), g_pOverlay->GetDevice());
...
void My_Render() {
    g_pDraw->DrawTextA("Hello, world! This should be rendered inside of Notepad!", 30, 50, 255, 0, 0);
}